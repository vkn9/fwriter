...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../utils/core */ \"./utils/core.js\");\n/* harmony import */ var _enum_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../enum/element */ \"./enum/element.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"insertImage\", function() { return _enum_element__WEBPACK_IMPORTED_MODULE_1__[\"insertImage\"]; });\n\n\n\n\nfunction handler(e) {\n  var image = prompt('image');\n  Object(_utils_core__WEBPACK_IMPORTED_MODULE_0__[\"exec\"])('insertimage', image);\n}\n\nfunction imageSelectHandler(e) {\n  var image = e.path[0];\n  var context = document.querySelectorAll('.fwt-editor')[0];\n\n  if (e.target.nodeName === 'IMG') {\n    var selection = window.getSelection();\n    var range = document.createRange();\n    range.selectNode(image);\n    selection.removeAllRanges();\n    selection.addRange(range);\n  }\n}\n\n_enum_element__WEBPACK_IMPORTED_MODULE_1__[\"insertImage\"].prop.event = [['click', 1, handler], ['click', 0, imageSelectHandler]];\n\n\n//# sourceURL=webpack:///./modules/image.js?");
